                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            onSubmitted: (value) {
                              int newValue =
                                  int.parse(value) < 5 ? 5 : int.parse(value);
                    ...
                    children: [
                      TextButton(
                          ...
                          style: TextButton.styleFrom(
                            backgroundColor: upper ? Colors.white : Colors.grey,
                      ...
                      TextButton(
                          ...
                          style: TextButton.styleFrom(
                            backgroundColor: lower ? Colors.white : Colors.grey,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10),
                                side: const BorderSide(
                                    width: 3, color: Colors.black)),
                      ...
                      TextButton(
                          ...
                          style: TextButton.styleFrom(
                            backgroundColor: digit ? Colors.white : Colors.grey,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10),
                                side: const BorderSide(
                                    width: 3, color: Colors.black)),
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                          ...
                          style: TextButton.styleFrom(
                            backgroundColor: space ? Colors.white : Colors.grey,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10),
                                side: const BorderSide(
                                    width: 3, color: Colors.black)),
                      ...
                      TextButton(
                          ...
                          style: TextButton.styleFrom(
                            backgroundColor:
                                special ? Colors.white : Colors.grey,
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(10),
                                side: const BorderSide(
                                    width: 3, color: Colors.black)),
