...
void main(){
  test('Template function creates a button for each database', (){
    ...
    Database newDatabase1 = Database("new database2", "/", "SECURE_PASSWORD123");
    Database newDatabase2 = Database("new database3", "/", "SECURE_PASSWORD123");
    ...
    final chooseButtons = [];
    chooseButtons.add(chooseDatabaseTemplate(databases[0], 0));
    chooseButtons.add(chooseDatabaseTemplate(databases[1], 1));
    chooseButtons.add(chooseDatabaseTemplate(databases[2], 2));

    final deleteButtons = databases.map((database) => deleteDatabaseTemplate(database,0,0)).toList();
